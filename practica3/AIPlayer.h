...
double Poda_AlfaBeta(const Parchis &actual, int id_jugador, int profundidad, int profundidad_max, color &c_piece, int &id_piece, int &dice, double alpha, double beta, double (*heuristic)(const Parchis &, int)) const ;

static double ValoracionTest1(const Parchis &estado, int jugador);

static double ValoracionTest2(const Parchis &estado, int jugador);
};
